...
document.addEventListener('DOMContentLoaded', function () {
  var swiper = new Swiper('.swiper-container', {
    slidesPerView: 3,         // Počet snímků na větších obrazovkách
    centeredSlides: true,     // Středový snímek je zvýrazněný
    spaceBetween: 30,         // Mezera mezi snímky
    loop: true,               // Plynulý přechod mezi snímky
    navigation: {
      nextEl: '.swiper-button-next',
      prevEl: '.swiper-button-prev',
    },
    breakpoints: {
      // Pro malé obrazovky (mobilní telefony)
      600: {
        slidesPerView: 1,     // Zobrazí 1 snímek
        spaceBetween: 10,
      },
      // Pro střední obrazovky (tablety)
      768: {
        slidesPerView: 2,     // Zobrazí 2 snímky
        spaceBetween: 20,
      },
      // Pro velké obrazovky (desktopy)
      1024: {
        slidesPerView: 3,     // Zobrazí 3 snímky
        spaceBetween: 30,
      },
    },
  });
